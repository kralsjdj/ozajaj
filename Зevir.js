...
module.exports.run = async (client, message, args) => {
  ...
  if (!v11Kod) {
    return message.channel.send(
      "V11 Kodunu Yaz \n Örnek : ?!kod-çevir RichEmbed"
    );
  }
  if (v11Kod.length > 1800) {
    return message.channel.send(
      "Kodun 1800 Karakter Sayısından Az Olmalı"
    );
  }
  let v12kod = v11Kod
    .split("get")
  ...
  if (v11Kod == v12kod) {
    return message.channel.send("V12 İle Uyumludur ");
  }
...
module.exports.help = {
  name: "kod-çevir",
  description: "kod çevirir",
  usage: "r!kod-çevir kod"
};
